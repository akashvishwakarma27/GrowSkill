...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> handleUserException(ClassNotFoundException ex, WebRequest wr){
	...
	public ResponseEntity<MyErrorDetails> handleUserException(CourseNotFoundException ex, WebRequest wr){
		MyErrorDetails myErrorDetails = new MyErrorDetails();
		myErrorDetails.setTimeStamp(LocalDate.now());
		myErrorDetails.setMessage(ex.getMessage());
		myErrorDetails.setDiscription(wr.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> handleUserException(EnrollmentNotFoundException ex, WebRequest wr){
		MyErrorDetails myErrorDetails = new MyErrorDetails();
		myErrorDetails.setTimeStamp(LocalDate.now());
		myErrorDetails.setMessage(ex.getMessage());
		myErrorDetails.setDiscription(wr.getDescription(false));
